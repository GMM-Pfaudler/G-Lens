...
const OfnGaResultPage = () => {
  ...
  const fetchResult = useCallback(async () => {
    try {
      ...
      const res = await fetch(`${API_BASE}/api/comparison/ofn-ga/result/${id}`, {
  ...
  return (
    <MainLayout
      breadcrumbItems={[
        ...
        { label: "OFN vs GA", href: "/ofn-ga-comparison"},
...
export default OfnGaResultPage;