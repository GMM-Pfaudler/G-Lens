...
from app.utils.image_comparison_utils._utils_for_char import CharUtils
...
class PDFHandler:
    ...
    def to_images(self, output_folder):
        ...
        # convert to image
        image_files = []
        images = convert_from_path(self.path, poppler_path=r"D:\Software_tools\poppler_for_pdf_to_image\poppler-24.08.0\Library\bin", fmt='jpeg', thread_count=8, dpi=200)
